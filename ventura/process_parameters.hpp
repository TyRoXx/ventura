...
namespace ventura
{
	...
	struct process_parameters
	{
		...
		/// stdout of the child process will be written to this sink. When nullptr,
		/// output is discarded.
		Si::Sink<char, Si::success>::interface *out;

		/// stderr of the child process will be written to this sink. When nullptr,
		/// output is discarded.
		Si::Sink<char, Si::success>::interface *err;

		/// provides stdin to the child process. When nullptr, the input will be
		/// empty.
